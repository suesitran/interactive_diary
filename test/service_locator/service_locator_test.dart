...
@GenerateMocks([RemoteConfigManager, AuthenticationService, LocationService, ConnectivityService, StorageService, GeocoderService])
void main() {
  ...
  test('test ServiceLocator', () async {
    ...
    ServiceLocator.instance.registerSingleton<ConnectivityService>(connectivityService);
