...
void main() {
  testWidgets('Verify UI of No connection screen', (WidgetTester widgetTester) async {
    ...
    expect(find.text('Slow or no internet connections.\nPlease check your internet settings'), findsOneWidget);
