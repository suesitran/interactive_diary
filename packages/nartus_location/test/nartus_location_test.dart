...
void main() {
    ...
    test(
        'given location data returns null latitude and longitude, when get current location, then throw LocationDataCorruptedException',
          ...
          when(location.getLocation())
              .thenAnswer((realInvocation) => Future.value(LocationData.fromMap({})));
  ...
  group('Test check permission', () {
    test('given PermissionStatus.granted, when checkPermission, then return PermissionStatusDiary.granted', () async {
    ...
    test('given PermissionStatus.denied, when checkPermission, then return PermissionStatusDiary.denied', () async {
    ...
    test('given PermissionStatus.restricted, when checkPermission, then return PermissionStatusDiary.denied', () async {
    ...
    test('given PermissionStatus.limited, when checkPermission, then return PermissionStatusDiary.denied', () async {
    ...
    test('given PermissionStatus.permanentlyDenied, when checkPermission, then return PermissionStatusDiary.deniedForever', () async {
    ...
    test('given no PermissionStatus, when checkPermission, then check from Permission.status', () {
      // mock method channel to avoid mocking on extension
      // ref: https://github.com/Baseflow/flutter-permission-handler/issues/262
      const MethodChannel('flutter.baseflow.com/permissions/methods')
          .setMockMethodCallHandler((MethodCall methodCall) async {
  ...
  group('Test request permission', () {
    test('given PermissionStatus.denied, when requestPermission, then call request permission from channel', () {
      // mock method channel to avoid mocking on extension
      // ref: https://github.com/Baseflow/flutter-permission-handler/issues/262
      const MethodChannel('flutter.baseflow.com/permissions/methods')
          .setMockMethodCallHandler((MethodCall methodCall) async {
    ...
    test('given PermissionStatus.restricted, when requestPermission, then call request permission from channel', () {
      // mock method channel to avoid mocking on extension
      // ref: https://github.com/Baseflow/flutter-permission-handler/issues/262
      const MethodChannel('flutter.baseflow.com/permissions/methods')
          .setMockMethodCallHandler((MethodCall methodCall) async {
    ...
    test('given PermissionStatus.limited, when requestPermission, then call request permission from channel', () {
      // mock method channel to avoid mocking on extension
      // ref: https://github.com/Baseflow/flutter-permission-handler/issues/262
      const MethodChannel('flutter.baseflow.com/permissions/methods')
          .setMockMethodCallHandler((MethodCall methodCall) async {
    ...
    test('given PermissionStatus.permanentlyDenied, when requestPermission, then call request permission from channel', () {
      // mock method channel to avoid mocking on extension
      // ref: https://github.com/Baseflow/flutter-permission-handler/issues/262
      const MethodChannel('flutter.baseflow.com/permissions/methods')
          .setMockMethodCallHandler((MethodCall methodCall) async {
