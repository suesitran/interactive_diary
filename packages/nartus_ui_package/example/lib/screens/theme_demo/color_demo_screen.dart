...
class ColorDemoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(
      children: [
        createColorDemo('Background color', Theme.of(context).backgroundColor),
        createColorDemo('bottomAppBarColor', Theme.of(context).bottomAppBarColor),
        createColorDemo('canvasColor', Theme.of(context).canvasColor),
        createColorDemo('cardColor', Theme.of(context).cardColor),
        createColorDemo('dialogBackgroundColor', Theme.of(context).dialogBackgroundColor),
        ...
        createColorDemo('primaryColorDark', Theme.of(context).primaryColorDark),
        createColorDemo('primaryColorLight', Theme.of(context).primaryColorLight),
        createColorDemo('Scaffold background color', Theme.of(context).scaffoldBackgroundColor),
        createColorDemo('secondaryHeaderColor', Theme.of(context).secondaryHeaderColor),
        createColorDemo('selectedRowColor', Theme.of(context).selectedRowColor),
        createColorDemo('shadowColor', Theme.of(context).shadowColor),
        createColorDemo('splashColor', Theme.of(context).splashColor),
        createColorDemo('toggleableActiveColor', Theme.of(context).toggleableActiveColor),
        createColorDemo('unselectedWidgetColor', Theme.of(context).unselectedWidgetColor),
      ],
    )
  );
}
