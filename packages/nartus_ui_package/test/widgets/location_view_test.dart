...
void main() {
  ...
  // testWidgets(
  //   'given the location is invalid and semantic label for coordinate has been specified, '
  //   'when location view rendered, '
  //   'then screen reader can read coordinate semantic label',
  //   (WidgetTester tester) async {
  //
  //   const LocationView widget = LocationView(
  //     latitude: 1.0, longitude: 1.0,
  //     semanticsAddress: 'semantics address',
  //     semanticsBusinessName: 'semantics business name',
  //     semanticsCoordinate: 'semantics coordinate',
  //   );
  //
  //   await tester.wrapMaterialAndPump(widget);
  //
  //   final Finder businessName = find.bySemanticsLabel(RegExp(r'semantics business name'));
  //   final Finder address = find.bySemanticsLabel(RegExp(r'semantics address'));
  //   final Finder coordinates = find.bySemanticsLabel(RegExp(r'semantics coordinate'));
  //
  //   expect(businessName, findsNothing);
  //   expect(address, findsNothing);
  //   expect(coordinates, findsOneWidget);
  ...
  //
  // testWidgets(
  //     'given the location is valid and semantic label for business name & address has been specified, '
  //     'when location view rendered, '
  //     'then screen reader can read business name & address semantic label',
  //     (WidgetTester tester) async {
  //
  //   const LocationView widget = LocationView(
  //     businessName: 'Ben Thanh Market',
  ...
  //   final Finder coordinates = find.bySemanticsLabel(RegExp(r'semantics coordinate'));
  //
  //   expect(widget.semanticsBusinessName, 'semantics business name');
  //   expect(widget.semanticsCoordinate, 'semantics coordinate');
  //   expect(widget.semanticsAddress, 'semantics address');
  //   expect(businessName, findsOneWidget);
  //   expect(address, findsOneWidget);
  //   expect(coordinates, findsNothing);
  // });
  ...
  //   await tester.wrapMaterialAndPump(widget);
  //
  //   expect(widget.semanticsBusinessName, 'Location business name is Ben Thanh Market');
  //   expect(widget.semanticsCoordinate, 'Location at latitude 1.0 and longitude 1.0');
  //   expect(widget.semanticsAddress, 'Location address is Lê Lợi, Phường Bến Thành, Quận 1, Thành phố Hồ Chí Minh, Vietnam');
  // });
}
