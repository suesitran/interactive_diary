...
void main() {
  group('Test when screen has no floating button, no action, no title', () {
    testWidgets(
      ...
      final screen = CupertinoApp(
        builder: (context, widget) => widget ?? const TestScreenBlank(),
      );
  ...
  group('Test when screen has Text action button', () {
    testWidgets('When OS is iOS, show Cupertino page scaffold with Text button',
        (widgetTester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
    ...
    testWidgets('When OS is android, show Material scaffold with Text button',
        (widgetTester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.android;
    ...
    testWidgets('When OS is windows, show Material scaffold with Text button',
        (widgetTester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.windows;
  ...
  group('test when screen has Icon action button', () {
    testWidgets('When OS is iOS, show Cupertino page scaffold with Icon button',
        (widgetTester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
      ...
      expect(
          find.descendant(
              of: find.byType(GestureDetector), matching: find.byType(Icon)),
          findsOneWidget);

      debugDefaultTargetPlatformOverride = null;
    });

    testWidgets('When OS is android, show Material scaffold with Icon button',
        (widgetTester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.android;
    ...
    testWidgets('When OS is windows, show Material scaffold with Icon button',
        (widgetTester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.windows;
