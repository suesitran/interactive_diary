...
final ElevatedButtonThemeData primaryButtonThemeData = ElevatedButtonThemeData(
    style: ButtonStyle(
        padding: const MaterialStatePropertyAll<EdgeInsetsGeometry>(EdgeInsets.symmetric(horizontal: 24, vertical: 14)),
...
final OutlinedButtonThemeData secondaryButtonThemeData = OutlinedButtonThemeData(
  style: ButtonStyle(
      padding: const MaterialStatePropertyAll<EdgeInsetsGeometry>(EdgeInsets.symmetric(horizontal: 24, vertical: 14)),
      textStyle: const MaterialStatePropertyAll<TextStyle>(_titleMedium),
      shape: const MaterialStatePropertyAll<OutlinedBorder>(RoundedRectangleBorder(
