...
class _DiaryHeader extends StatelessWidget {
  ...
  const _DiaryHeader({required this.avatarPath, required this.displayName, required this.dateTime, Key? key}) : super(key: key);
    ...
    child: Row(
      children: [
        ...
        Expanded(child: Padding(
          padding: const EdgeInsets.only(left: NartusDimens.padding10, right: NartusDimens.padding10),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(displayName, style: Theme.of(context).textTheme.titleSmall,),
              Text(S.of(context).diaryDateFormatter(
